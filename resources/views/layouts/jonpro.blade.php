...
@section('css_main')
<link rel="stylesheet" type="text/css" href="{{asset('gentella/vendors/select2/dist/css/select2.min.css')}}">
@yield('css')
@endsection
@section('main')
            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="{{asset('gentella/production/images/img.jpg')}}" alt="..." class="img-circle profile_img">
                    </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li class="{{isActiveRoute('home')}}{{isActiveRoute('home2')}}{{ isActiveRoute('home.*') }}"><a href="{{route('home')}}"><i class="fa fa-home"></i> {{__('layout.home')}}</a></li>
