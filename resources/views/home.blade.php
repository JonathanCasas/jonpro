                                    ...
                                    @if($dayTasks->isNotEmpty())
                                        @foreach($dayTasks as $task)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-info btn-sm task"
                                                            task="{{$task->id}}">
                                                        <i class="fa fa-eye"></i>
                                                    </button>
                                                </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12">
                                <div class="form-group">
                                    <b>Priority</b>
                                    <div class="form-line">
                                        <select name="priority" id="sl-priority" class="form-control jonpro-select"
                                                required="" readonly="">
                                            <option value="">-- Select --</option>
                                            @foreach($priorities as $priority)
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12">
                                <div class="form-group">
                                    <b>Assigned To</b>
                                    <div class="form-line">
                                        <select name="assigned_to" id="sl-assigned_to" class="form-control users"
                                                required="" readonly="">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12">
                                <div class="form-group">
                                    <b>Start Date</b>
                                    <div class="form-line">
                                        <input type="text" readonly="" class="form-control date" id="txt-start_date"
                                               name="start_date">
                                    </div>
                                </div>
                            </div>
